...
export const techStackIcons: TechStackIcon[] = [
  {
    image: '${basePath}/images/icons/html.svg',
    title: 'html',
    width: 120,
    height: 120,
  },
  {
    image: '${basePath}/images/icons/css.svg',
    title: 'css',
    width: 120,
    height: 119,
  },
  {
    image: '${basePath}/images/icons/js.svg',
    title: 'java script',
    width: 120,
    height: 120,
  },
  {
    image: '${basePath}/images/icons/react.svg',
    title: 'react',
    width: 113,
    height: 101,
  },
  {
    image: '${basePath}/images/icons/redux.svg',
    title: 'redux',
    width: 105,
    height: 100,
  },
  {
    image: '${basePath}/images/icons/bootstrap.svg',
    title: 'bootstrap',
    width: 88,
    height: 87,
  },
  {
    image: '${basePath}/images/icons/tailwind.svg',
    title: 'tailwind',
    width: 131,
    height: 131,
  },
  {
    image: '${basePath}/images/icons/sass.svg',
    title: 'sass',
    width: 117,
    height: 87,
  },
  {
    image: '${basePath}/images/icons/git.svg',
    title: 'git',
    width: 105,
    height: 105,
  },
  {
    image: '${basePath}/images/icons/greensock.svg',
    title: 'greensock',
    width: 120,
    height: 120,
  },
  {
    image: '${basePath}/images/icons/vscode.svg',
    title: 'vscode',
    width: 112,
    height: 112,
  },
  {
    image: '${basePath}/images/icons/github.svg',
    title: 'github',
    width: 88,
    height: 88,
  },
...
export const projectItems: ProjectInfo[] = [
  {
    image: '${basePath}/images/projects/project-01.avif',
  ...
  {
    image: '${basePath}/images/projects/project-02.avif',
  ...
  {
    image: '${basePath}/images/projects/project-03.avif',
  ...
  {
    image: '${basePath}/images/projects/project-04.avif',
  ...
  {
    image: '${basePath}/images/projects/project-05.avif',
  ...
  {
    image: '${basePath}/images/projects/project-06.avif',
